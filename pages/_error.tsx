...
function Error({ statusCode, errorType }: ErrorProps) {
  const isNetworkBlocked = errorType === 'NetworkBlockedError'
  const isConfigMissing = errorType === 'SUPABASE_CONFIG_MISSING'

  if (isNetworkBlocked || isConfigMissing) {
    return (
        ...
        <div className="max-w-2xl w-full bg-white rounded-lg shadow-xl p-8 border-2 border-orange-200">
              ...
              <div>
                ...
                <ul className="text-sm text-gray-700 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>תוכנת <strong>FortiClient</strong>, VPN או Firewall חוסמים את הגישה לשרתי האתר</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-orange-500">•</span>
              ...
              <div>
                ...
                <ol className="text-sm text-gray-700 space-y-3">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>אם אתם ברשת ארגונית, צרו קשר עם מנהל המערכת להוספת האתר לרשימת החריגים</span>
                  </li>
                  <li className="flex items-start gap-2">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs text-gray-500 text-center">
              אם הבעיה נמשכת, צרו קשר בוואטסאפ: <a href="https://wa.me/972586412420" className="text-blue-600 underline">0586412420</a>
            </p>
          </div>
        </div>
      </div>
