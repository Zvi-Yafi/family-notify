              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {!formData.createNew ? (
                  <div>
                    ...
                    />
                    <p className="text-sm text-gray-500 mt-1">
                      בקשו את קוד הקבוצה ממנהל המשפחה
                    </p>
                  </div>
                ) : (
                  <div>
                    ...
                    {formData.groupSlug && (
                      <p className="text-sm text-gray-500 mt-1">
                        קוד הקבוצה: <span className="font-mono font-bold">{formData.groupSlug}</span>
                      </p>
                    )}
                  </div>
                )}
