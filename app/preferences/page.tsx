...
export default function PreferencesPage() {
  ...
  const getChannelName = (channel: string) => {
    switch (channel) {
      ...
      case 'PUSH': return 'התראות'
    }
  }

  const getChannelDescription = (channel: string) => {
    switch (channel) {
      case 'EMAIL': return 'קבלת הודעות באימייל'
      case 'SMS': return 'הודעות SMS לטלפון הנייד'
      case 'WHATSAPP': return 'הודעות ב-WhatsApp'
      case 'PUSH': return 'התראות בדפדפן'
    }
  }
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        />
                        {!pref.verified ? (
                          <Button onClick={() => verifyChannel(index)}>
                            אמת
                          </Button>
                        ) : (
