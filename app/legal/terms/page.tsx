      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card>
          ...
          <CardContent className="prose prose-rtl dark:prose-invert max-w-none">
            ...
            <p>
              FamilyNotify היא פלטפורמה לשליחת הודעות ואירועים משפחתיים דרך ערוצים מרובים
              (Email, SMS, WhatsApp, Web Push). השירות מיועד לשימוש אישי ומשפחתי בלבד.
            </p>
            ...
            <h2>5. תוכן משתמש</h2>
            <p>
              אתה שומר על כל הזכויות לתוכן שאתה שולח. אנו לא אחראים לתוכן שנשלח על ידי משתמשים.
            ...
            <p>
              השירות הבסיסי חינמי. ייתכנו עלויות עבור:
            </p>
            <ul>
            ...
            <p>
              השירות ניתן &quot;כמות שהוא&quot; (AS IS). איננו מבטיחים:
            </p>
            <ul>
            ...
            <p>
              לא נהיה אחראים לנזקים ישירים או עקיפים הנובעים משימוש בשירות.
            </p>
            ...
            <p>
              כל הזכויות ב-FamilyNotify (קוד, עיצוב, לוגו) שייכות לנו. אסור להעתיק או לשכפל
              את השירות ללא רשות.
            </p>

            <h2>11. שינויים בתנאים</h2>
            <p>
              אנו עשויים לעדכן תנאים אלה. נודיע לך על שינויים משמעותיים.
              המשך שימוש לאחר שינוי מהווה הסכמה לתנאים החדשים.
            </p>

            <h2>12. דין וסמכות שיפוט</h2>
            <p>
              תנאים אלה כפופים לדיני מדינת ישראל. סמכות השיפוט הייחודית תהיה לבתי המשפט
              בישראל.
            </p>
