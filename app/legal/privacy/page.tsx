      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card>
          ...
          <CardContent className="prose prose-rtl dark:prose-invert max-w-none">
            <h2>1. מבוא</h2>
            <p>
              ברוכים הבאים ל-FamilyNotify. אנו מחויבים להגן על פרטיותך ולנהל את המידע האישי שלך באופן אחראי.
            ...
            <ul>
              <li><strong>מידע אישי</strong>: כתובת אימייל, מספר טלפון (אופציונלי)</li>
              <li><strong>מידע על העדפות</strong>: ערוצי קבלה מועדפים (Email, SMS, WhatsApp, Push)</li>
              <li><strong>מידע על שימוש</strong>: לוגים של שליחות, זמני גישה למערכת</li>
              <li><strong>קבוצות משפחתיות</strong>: חברות בקבוצות, תפקידים</li>
            </ul>
            ...
            <p>יש לך את הזכות:</p>
            <ul>
              <li><strong>לגשת</strong> למידע האישי שלך</li>
              <li><strong>לתקן</strong> מידע שגוי</li>
              <li><strong>למחוק</strong> את החשבון והמידע שלך</li>
              <li><strong>לייצא</strong> את המידע שלך (Data Portability)</li>
              <li><strong>לבטל</strong> את ההסכמה לשליחת הודעות בכל עת</li>
            </ul>

            <h2>7. עוגיות (Cookies)</h2>
            <p>
              אנו משתמשים בעוגיות טכניות הכרחיות לתפעול המערכת (אימות, העדפות).
              אין לנו עוגיות שיווקיות או מעקב צד שלישי.
            </p>

            <h2>8. עדכונים למדיניות</h2>
            <p>
              אנו עשויים לעדכן מדיניות זו מעת לעת. נודיע לך על שינויים משמעותיים באימייל
              או הודעה במערכת.
            </p>
