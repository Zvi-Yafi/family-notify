...
import { Mail, Chrome, AlertCircle, Lock, User } from 'lucide-react'
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <a href="/legal/terms" className="underline hover:text-primary mx-1">
              תנאי השימוש
            </a>
            ול
            <a href="/legal/privacy" className="underline hover:text-primary mx-1">
              מדיניות הפרטיות
            </a>
          </p>
        </CardContent>
